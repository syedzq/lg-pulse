...
export default function InfluencerVariantPage() {
    ...
    return (
        <div className="max-w-screen-lg mx-auto">
            ...
            {/* Insights section with grid layout */}
            <div className="px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {/* Fundraising Chart */}
                    <div>
                        <BorderlessDataCard title="Total funds raised" expandable>
                            <div className="space-y-4">
                                <div className="flex justify-start border-b border-neutral-200">
                                    {[
                    ...
                    {/* Map */}
                    <div>
                        <BorderlessDataCard title="Top countries" expandable>
                            {({ expanded }) => (
